...
// `buildFlowUxRecoveryKickoff` / `buildScreenLinkRecoveryKickoff` (skill
// `docs-flow-ux`) đã bỏ 2026-08-28 (wp-docs-review-confirm-v2): dr-flow nay là
// generator docs-screen-flow, không còn vòng recovery agent.
