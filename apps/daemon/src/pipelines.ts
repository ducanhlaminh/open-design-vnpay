...
export const PIPELINE_DEFS: readonly PipelineDef[] = [
  ...
  { id: 'docs',             name: 'Tài liệu (nạp)',                skillId: 'jira-ingest',           dependsOn: [],                                       outputs: ['docs/jira/', 'docs/confluence/', 'docs/context/'], inputPlaceholder: 'Confluence page URL/id, or JIRA project key / JQL' },
  ...
  { id: 'prd-docs',         name: 'Tài liệu (nạp)',                skillId: 'jira-ingest',           dependsOn: [],              outputs: ['docs/jira/', 'docs/confluence/', 'docs/context/'], inputPlaceholder: 'Confluence page URL/id, or JIRA project key / JQL' },
  ...
  { id: 'dr-docs',          name: 'Tài liệu (nạp)',                   skillId: 'jira-ingest',           dependsOn: [],                   outputs: ['docs/'], inputPlaceholder: 'Confluence page URL/id, or JIRA project key / JQL', acceptsUpload: true },
