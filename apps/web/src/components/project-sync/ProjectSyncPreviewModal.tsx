  ...
  const footer = (
    <div className={styles.footer}>
      ...
      <div className={styles.footerActions}>
        ...
        <button type="button" className="pl-btn pl-btn--primary" onClick={() => void apply()} disabled={!plan || loading || refreshing || applying || expired || completedSuccessfullyRef.current}>
