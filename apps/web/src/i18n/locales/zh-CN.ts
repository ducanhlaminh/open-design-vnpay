...
export const zhCN: Dict = {
  ...
  'designs.group.unassigned': '未分配',
  'home.kgScope.label': '项目',
  'home.kgScope.help': '新对话将归属到该项目（KGS）',
  'home.kgScope.none': '无项目',
  ...
  'project.kgScopeTitle': '此对话归属于 KGS 项目 {name}',
  ...
  'fileViewer.pushToKg': '推送到知识图谱',
  'fileViewer.pushToKgTitle': '将此客户旅程 / UX 规格推送到知识图谱（open-design 应用）',
  'fileViewer.pushToKgProject': '目标 SimStudio 项目',
  'fileViewer.pushToKgProjectLocked': '项目（已绑定到此对话）',
  'fileViewer.pushToKgNoProjects': '无项目',
  'fileViewer.pushToKgInvalid': '推送前请修复 schema 错误：',
  'fileViewer.pushToKgPickProject': '请先选择目标项目',
  'fileViewer.specPreview': '预览',
  'fileViewer.pushToKgRunning': '推送中…',
  'fileViewer.pushToKgDone': '已推送 {n} 个节点 + {e} 条边 — 打开 SimStudio 并点击 Pull All',
  'fileViewer.pushToKgFailed': '推送失败：{msg}',
