...
export const zhCN: Dict = {
  ...
  'designs.scopeAria': '项目范围',
  'designs.scopeOverview': '概览',
  'designs.scopePipelines': '流程 ({count})',
  'designs.scopePipelinesTitle': '流程项目（文档 → 原型工作流）',
  'designs.scopeFigmaDs': 'Figma Design system ({count})',
  ...
  'ds.reactStats': '{components} 个组件 · {icons} 个图标',
  'ds.reactDetailToggle': '组件库',
  'ds.reactDetailLoading': '正在加载组件库…',
  'ds.managerAreaLabel': '设计系统区域',
  'ds.managerTabSystem': '设计系统',
  'ds.managerTabTemplate': '模板',
  'ds.managerSourceLabel': '设计系统来源',
  'ds.managerEnterpriseSourceLabel': '企业设计系统类型',
  'ds.managerFigmaLinksTab': '来自 Figma 链接',
  'ds.managerFigmaLinksTabDescription': '用于评审工作流的组件目录',
  'ds.managerReactZipTab': '来自 .zip 文件的 React',
  'ds.managerReactZipTabDescription': '包含令牌、React 包和 Showcase',
  'ds.managerYourSystems': '你的系统',
  'ds.managerOfficialPresets': 'Markdown 设计系统',
  'ds.managerEnterprise': '企业设计系统',
  'ds.managerTemplateSourceLabel': '模板来源',
  'ds.managerYourTemplates': '你的模板',
  'ds.managerLibrary': '资源库',
  'ds.managerPlatformFilter': '平台筛选',
  'ds.managerFilterAria': '筛选设计系统',
  'ds.managerPublished': '已发布',
  'ds.managerDraft': '草稿',
  'ds.managerCreateTitle': '创建新的设计系统',
  'ds.managerCreateDescription': '将你的品牌、产品、代码、素材和设计参考提供给 Open Design。',
  'ds.managerCreateAction': '创建',
  'ds.managerImportingFigma': '正在从 Figma 导入…',
  'ds.managerImportFigma': '从 Figma 导入 (.zip)',
  'ds.managerImportDescription': '选择由 Fig Pipeline 插件导出的 zip 文件：先 foundation，后 UI 库（命名为 01-/02-）。上传时会编译 React 包和 token。',
  'ds.managerImportAction': '导入',
  'ds.managerImportWarnings': '{count} 条导入警告',
  'ds.managerEmptySystems': '还没有设计系统。请从真实产品上下文创建，审核草稿后发布给后续项目使用。',
  'ds.managerUpdatedByYou': '你 · 更新于 {date}',
  'ds.managerComingSoon': '即将推出',
  'ds.managerEnterpriseSystems': '企业设计系统',
  'ds.managerEnterpriseSystemsBody': '团队共享设计系统和受管理的品牌库即将推出。',
  'ds.managerEmptyTemplates': '还没有模板。启用模板发布后，可通过“分享”从任意生成的项目创建模板。',
  'ds.managerCreatedFromProject': '从项目创建',
  'ds.managerEnterpriseTemplates': '企业模板',
  'ds.managerEnterpriseTemplatesBody': '团队批准的模板和全组织发布即将推出。',
  'ds.figmaLinksTitle': '从 Figma 链接加载设计系统',
  'ds.figmaLinksDescription': '将 1-5 个 Figma 文件保存为可复用的组件目录。此来源不包含 Showcase 或 React bundle。',
  'ds.figmaLinksAddAction': '添加 Figma 链接',
  'ds.figmaLinksEmpty': '还没有 Figma 组件目录。请添加项目要使用的库文件。',
  'ds.figmaLinksLoadError': '无法加载 Figma 设计系统。',
  'ds.figmaLinksCreateTitle': '从 Figma 链接加载设计系统',
  'ds.figmaLinksEditTitle': '编辑 Figma 设计系统',
  'ds.figmaLinksNameLabel': '设计系统名称',
  'ds.figmaLinksNameHint': '使用团队熟悉的库或产品名称。',
  'ds.figmaLinksLinksLabel': 'Figma 文件链接',
  'ds.figmaLinksLinksHint': '粘贴 1-5 个链接，每行一个。重复文件会被忽略。',
  'ds.figmaLinksCreateAction': '加载目录',
  'ds.figmaLinksSaveError': '无法保存 Figma 设计系统。',
  'ds.figmaLinksStatusReady': '已就绪',
  'ds.figmaLinksStatusRefreshing': '正在刷新',
  'ds.figmaLinksStatusRefreshingProgress': '正在加载 {completed}/{total}',
  'ds.figmaLinksStatusError': '需要检查',
  'ds.figmaLinksStatusEmpty': '尚未加载',
  'ds.figmaLinksFiles': 'Figma 文件',
  'ds.figmaLinksComponents': '组件',
  'ds.figmaLinksUpdatedAt': '目录更新于 {date}',
  'ds.figmaLinksRefreshAction': '重新运行更新',
  'ds.figmaLinksRefreshRunning': '正在更新…',
  'ds.figmaLinksRefreshCompleted': '更新完成',
  'ds.figmaLinksRefreshSummary': '+{added} 新增 · −{removed} 删除 · {changed} 更改',
  'ds.figmaLinksRefreshTotal': '最新目录中有 {count} 个组件',
  'ds.figmaLinksRefreshError': '无法刷新组件目录。',
  'ds.figmaLinksDeleteAria': '删除 {name}',
  'ds.figmaLinksDeleteConfirm': '删除“{name}”？使用此来源的项目需要选择其他组件来源。',
  'ds.figmaLinksDeleteError': '无法删除 Figma 设计系统。',
  ...
  'chat.displayModeAria': '切换技术细节',
  'chat.displayModeSimpleTitle': '简洁视图 — 已隐藏技术步骤。点击可显示。',
  'chat.displayModeFullTitle': '详细视图 — 正在显示技术步骤。点击可简化。',
  ...
  'workspace.previewMenu': '预览',
  'workspace.reloadPreview': '重新加载预览',
  'workspace.previewNotReady': '暂无输出',
  'workspace.previewStage.docsMap': '系统地图',
  'workspace.previewStage.cj': '客户旅程',
  'workspace.previewStage.uxResearch': 'UX 调研',
  'workspace.previewStage.ux': 'UX 规格',
  'workspace.previewStage.uxReview': 'UX 评审',
  'workspace.previewStage.uiHtml': 'UI 原型（HTML）',
  'workspace.previewStage.uiReact': 'UI 原型（React）',
  'workspace.previewStage.uiReactDs': 'UI 原型（React + DS）',
  'workspace.previewStage.prdReview': 'PRD 评审',
  'workspace.previewStage.drReview': '文档评审',
  ...
  'settings.designSystemsFigmaFiles': 'Figma IR 文件',
  'settings.designSystemsFigmaFilesHelp': '选择 Fig Pipeline 插件导出的 .ir.json 文件或 .zip 包。合并顺序按文件名排序——用 01-、02- 前缀，foundation（令牌）文件放最前。',
  'settings.designSystemsImportFigma': '导入 Figma IR',
  'settings.designSystemsImportWarnings': '{count} 条导入警告',
