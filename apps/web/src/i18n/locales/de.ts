...
export const de: Dict = {
  ...
  'settings.agentAuthOk': 'Angemeldet',
  ...
  'ds.reactStats': '{components} Komponenten · {icons} Icons',
  'ds.reactDetailToggle': 'Komponentenbibliothek',
  'ds.reactDetailLoading': 'Komponentenbibliothek wird geladen…',
  ...
  'chat.displayModeAria': 'Technische Details ein- oder ausblenden',
  'chat.displayModeSimpleTitle': 'Vereinfachte Ansicht — technische Schritte sind ausgeblendet. Klicken zum Anzeigen.',
  'chat.displayModeFullTitle': 'Detailansicht — technische Schritte sind sichtbar. Klicken zum Vereinfachen.',
  ...
  'settings.designSystemsFigmaFiles': 'Figma-IR-Dateien',
  'settings.designSystemsFigmaFilesHelp': 'Wähle .ir.json-Exporte und/oder das .zip-Bundle des Fig-Pipeline-Plugins. Die Merge-Reihenfolge folgt der Dateinamen-Reihenfolge — Präfix 01-, 02-, …, die Foundation-(Token-)Datei zuerst.',
  'settings.designSystemsImportFigma': 'Figma IR importieren',
  'settings.designSystemsImportWarnings': '{count} Import-Warnungen',
  ...
  'assistant.sandboxedTitle': 'Dieser Lauf wurde in einer isolierten Docker-Sandbox ausgeführt',
  'settings.sandboxTitle': 'Agent-Sandbox',
  'settings.sandboxHint': 'Führt freigegebene Pipeline-Agenten in einem isolierten Docker-Container aus. Erfordert Docker/OrbStack.',
  'settings.sandboxEnabled': 'Sandbox für {runtimes}-Läufe der Skills: {skills}',
  'settings.sandboxDocker': 'Docker-Engine',
  'settings.sandboxImage': 'Sandbox-Image',
  'settings.sandboxAuth': 'Claude-Login (Auth-Volume)',
  'settings.sandboxActiveRuns': 'Aktive Sandbox-Läufe',
  'settings.sandboxOk': 'OK',
  'settings.sandboxMissing': 'fehlt',
  'settings.sandboxRunCmd': 'ausführen: {cmd}',
  'settings.sandboxDaemonOffline': 'Daemon offline — Sandbox-Status nicht verfügbar.',
