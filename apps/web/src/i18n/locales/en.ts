...
export const en: Dict = {
  ...
  'designs.group.unassigned': 'Unassigned',
  'home.kgScope.label': 'Project',
  'home.kgScope.help': 'New conversations are scoped to this project (KGS)',
  'home.kgScope.none': 'No project',
  ...
  'project.kgScopeTitle': 'This conversation is scoped to KGS project {name}',
  ...
  'fileViewer.pushToKg': 'Push to KG',
  'fileViewer.pushToKgTitle': 'Push this Customer Journey / UX Spec into the Knowledge Graph (open-design app)',
  'fileViewer.pushToKgProject': 'Target SimStudio project',
  'fileViewer.pushToKgProjectLocked': 'Project (locked to this conversation)',
  'fileViewer.pushToKgNoProjects': 'No projects',
  'fileViewer.pushToKgInvalid': 'Fix schema errors before pushing:',
  'fileViewer.pushToKgPickProject': 'Pick a target project first',
  'fileViewer.specPreview': 'Preview',
  'fileViewer.pushToKgRunning': 'Pushing…',
  'fileViewer.pushToKgDone': 'Pushed {n} nodes + {e} edges — open SimStudio and click Pull All',
  'fileViewer.pushToKgFailed': 'Push failed: {msg}',
