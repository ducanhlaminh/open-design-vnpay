...
export const en: Dict = {
  ...
  'settings.agentAuthOk': 'Signed in',
  ...
  'confluenceConfig.tokenCreateLink': 'Tạo token trên Confluence →',
  'confluenceConfig.tokenInstructions': 'Mở Confluence ở tab mới → Đăng nhập nếu cần → Bấm "Create token" → Đặt tên bất kỳ → Copy token vừa tạo và dán vào ô bên dưới.',
  'confluenceConfig.testButton': 'Test connection',
  'confluenceConfig.testing': 'Testing…',
  'confluenceConfig.testSuccess': 'Connected successfully.',
  'confluenceConfig.testSuccessNamed': 'Connected as {name}.',
  'confluenceConfig.testFailed': 'Connection failed.',
  ...
  'designs.scopeAria': 'Project scope',
  'designs.scopeOverview': 'Overview',
  'designs.scopePipelines': 'Pipelines ({count})',
  'designs.scopePipelinesTitle': 'Pipeline projects (docs → prototype workflows)',
  ...
  'ds.reactStats': '{components} components · {icons} icons',
  'ds.reactDetailToggle': 'Component library',
  'ds.reactDetailLoading': 'Loading component library…',
  'ds.managerAreaLabel': 'Design systems area',
  'ds.managerTabSystem': 'Design system',
  'ds.managerTabTemplate': 'Template',
  'ds.managerSourceLabel': 'Design system source',
  'ds.managerEnterpriseSourceLabel': 'Enterprise design system type',
  'ds.managerFigmaLinksTab': 'From Figma links',
  'ds.managerFigmaLinksTabDescription': 'Component catalog for review workflows',
  'ds.managerReactZipTab': 'React from a .zip file',
  'ds.managerReactZipTabDescription': 'Includes tokens, a React bundle, and Showcase',
  'ds.managerYourSystems': 'Your systems',
  'ds.managerOfficialPresets': 'Design system markdown',
  'ds.managerEnterprise': 'Enterprise design systems',
  'ds.managerTemplateSourceLabel': 'Template source',
  'ds.managerYourTemplates': 'Your templates',
  'ds.managerLibrary': 'Library',
  'ds.managerPlatformFilter': 'Platform filter',
  'ds.managerFilterAria': 'Filter design systems',
  'ds.managerPublished': 'Published',
  'ds.managerDraft': 'Draft',
  'ds.managerCreateTitle': 'Create new design system',
  'ds.managerCreateDescription': 'Teach Open Design your brand, product, code, assets, and design references.',
  'ds.managerCreateAction': 'Create',
  'ds.managerImportingFigma': 'Importing from Figma…',
  'ds.managerImportFigma': 'Import React design system from Figma (.zip)',
  'ds.managerImportDescription': 'Use files exported by the Fig Pipeline plugin when you need a React bundle, tokens, and Showcase. This is separate from a Figma link catalog.',
  'ds.managerImportAction': 'Import',
  'ds.managerImportWarnings': '{count} import warnings',
  'ds.managerEmptySystems': 'No design systems yet. Create one from real product context, review the draft, then publish it for future projects.',
  'ds.managerUpdatedByYou': 'You · updated {date}',
  'ds.managerComingSoon': 'Coming soon',
  'ds.managerEnterpriseSystems': 'Enterprise design systems',
  'ds.managerEnterpriseSystemsBody': 'Shared team design systems and governed brand libraries are coming soon.',
  'ds.managerEmptyTemplates': 'No templates yet. Create one from any generated project via Share once template publishing is enabled.',
  'ds.managerCreatedFromProject': 'Created from a project',
  'ds.managerEnterpriseTemplates': 'Enterprise templates',
  'ds.managerEnterpriseTemplatesBody': 'Team-approved templates and organization-wide publishing are coming soon.',
  'ds.figmaLinksTitle': 'Load design system from Figma links',
  'ds.figmaLinksDescription': 'Save 1-5 Figma files as a reusable component catalog. This source has no Showcase or React bundle.',
  'ds.figmaLinksAddAction': 'Add Figma links',
  'ds.figmaLinksEmpty': 'No Figma component catalogs yet. Add the library files your projects should use.',
  'ds.figmaLinksLoadError': 'Could not load Figma design systems.',
  'ds.figmaLinksCreateTitle': 'Load design system from Figma links',
  'ds.figmaLinksEditTitle': 'Edit Figma design system',
  'ds.figmaLinksNameLabel': 'Design system name',
  'ds.figmaLinksNameHint': 'Use a familiar library or product name.',
  'ds.figmaLinksLinksLabel': 'Figma file links',
  'ds.figmaLinksLinksHint': 'Paste 1-5 links, one per line. Duplicate files are ignored.',
  'ds.figmaLinksCreateAction': 'Load catalog',
  'ds.figmaLinksSaveError': 'Could not save the Figma design system.',
  'ds.figmaLinksStatusReady': 'Ready',
  'ds.figmaLinksStatusRefreshing': 'Refreshing',
  'ds.figmaLinksStatusRefreshingProgress': 'Refreshing {completed}/{total}',
  'ds.figmaLinksStatusError': 'Needs attention',
  'ds.figmaLinksStatusEmpty': 'Not loaded',
  'ds.figmaLinksFiles': 'Figma files',
  'ds.figmaLinksComponents': 'Components',
  'ds.figmaLinksUpdatedAt': 'Catalog updated {date}',
  'ds.figmaLinksRefreshAction': 'Rerun update',
  'ds.figmaLinksRefreshRunning': 'Updating…',
  'ds.figmaLinksRefreshCompleted': 'Update completed',
  'ds.figmaLinksRefreshSummary': '+{added} added · −{removed} removed · {changed} changed',
  'ds.figmaLinksRefreshTotal': '{count} components in the latest catalog',
  'ds.figmaLinksRefreshError': 'Could not refresh the component catalog.',
  'ds.figmaLinksDeleteAria': 'Delete {name}',
  'ds.figmaLinksDeleteConfirm': 'Delete "{name}"? Projects using this source will need another component source.',
  'ds.figmaLinksDeleteError': 'Could not delete the Figma design system.',
  ...
  'chat.displayModeAria': 'Toggle technical details',
  'chat.displayModeSimpleTitle': 'Simplified view — technical steps are hidden. Click to show them.',
  'chat.displayModeFullTitle': 'Detailed view — technical steps are shown. Click to simplify.',
  ...
  'workspace.previewMenu': 'Preview',
  'workspace.reloadPreview': 'Reload preview',
  'workspace.previewNotReady': 'No output yet',
  'workspace.previewStage.docsMap': 'System map',
  'workspace.previewStage.cj': 'Customer journey',
  'workspace.previewStage.uxResearch': 'UX research',
  'workspace.previewStage.ux': 'UX spec',
  'workspace.previewStage.uxReview': 'UX review',
  'workspace.previewStage.uiHtml': 'UI prototype (HTML)',
  'workspace.previewStage.uiReact': 'UI prototype (React)',
  'workspace.previewStage.uiReactDs': 'UI prototype (React + DS)',
  'workspace.previewStage.prdReview': 'PRD review',
  'workspace.previewStage.drReview': 'Docs review',
  ...
  'settings.designSystemsFigmaFiles': 'Figma IR files',
  'settings.designSystemsFigmaFilesHelp': 'Select .ir.json exports and/or the plugin\'s .zip bundle from Fig Pipeline. Merge order follows filename order — prefix 01-, 02-, … with the foundation (token) file first.',
  'settings.designSystemsImportFigma': 'Import Figma IR',
  'settings.designSystemsImportWarnings': '{count} import warnings',
  ...
  'settings.executionModeTitle': 'Execution mode',
  'settings.executionModeHint': 'Host CLI runs Claude directly with the CLI already installed on this machine (default). Docker sandbox isolates the agent in a container.',
  'settings.executionModeHost': 'Host CLI (default)',
  'settings.executionModeSandbox': 'Docker sandbox',
