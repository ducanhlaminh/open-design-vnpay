...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%OD_INSTALLER%" -Start
set "OD_EXIT=%ERRORLEVEL%"
echo.
if "%OD_EXIT%"=="0" (
  echo Open Design is running.
) else (
  echo Open Design could not be started. Review the message above.
)
